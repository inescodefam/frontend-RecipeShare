...
import 'package:admin/screens/register_screen.dart';
...
Future<void> _pumpWithRouter(
  ...
  final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/dashboard', builder: (_, __) => const Text('dashboard-target')),
    ],
  );
...
void main() {
  testWidgets('login validates and navigates on success', (tester) async {
    ...
    await tester.enterText(find.bySemanticsLabel('Email'), 'admin@example.com');
  ...
  testWidgets('register validates and navigates on success', (tester) async {
    ...
    await tester.enterText(find.bySemanticsLabel('Username'), 'admin-user');
    await tester.enterText(find.bySemanticsLabel('Email'), 'admin2@example.com');
