...
class HttpAdminCategoriesService implements AdminCatalogHttp {
  HttpAdminCategoriesService(this._dio);

  final Dio _dio;

  Future<List<AdminCatalogRow>> fetchAll() async {
    final res = await _dio.get<dynamic>('/api/admin/categories');
    final data = res.data;
  ...
  Future<void> toggleActive(int id) async {
    await _dio.patch<void>('/api/admin/categories/$id/toggle-IsActive');
  }
